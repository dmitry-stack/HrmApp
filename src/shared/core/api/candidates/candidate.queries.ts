...
import type { CreateCandidateDto } from '@/entities/candidate';
...
// Alias for backward compatibility if any callers used the typo
export const useDeleteCandiadte = useDeleteCandidate;
